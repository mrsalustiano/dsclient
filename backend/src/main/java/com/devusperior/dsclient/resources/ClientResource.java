package com.devusperior.dsclient.resources;
...
import com.devusperior.dsclient.services.ClientService;
...
public class ClientResource {
	...
	public ResponseEntity<Page<ClientDTO>> findAll(
		...
		Page<ClientDTO> pageReturn = service.findAllPaged(pageRequest);
